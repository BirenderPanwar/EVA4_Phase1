...
def build_model(model, device, trainloader, testloader, epochs, criterion, optimizer, lr_scheduler=None, L1_loss_enable=False):
    ...
    for epoch in range(1,epochs+1):
      ...
      train_acc, train_loss = train(model, device, trainloader, criterion, optimizer, lr_scheduler, L1_loss_enable=L1_loss_enable)
